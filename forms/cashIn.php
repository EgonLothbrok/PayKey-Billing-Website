...
if (isset($_POST["btnSubmit"])) {
        ...
        if (password_verify($inpPassword, $_userPassword)) {
                ...
                // Reffered Amount Verification
                if ($amount < 100 || $amount > 100000) {
                        echo "<script>alert('Invalid Amount, Try Again')</script>";
                } else {
...
<body>
        <div class="container d-flex justify-content-center align-item-center">
                <div class="border row p-0 shadow-sm rounded w-75 m-lg-5 m-2 bg-light animate__animated animate__fadeInUp">
                        ...
                        <div class="d-none d-lg-flex col-lg-5 col-12 d-flex flex-column justify-content-center align-items-center border rounded  process-bg">
                        ...
                        <div class="col-12 col-lg-7">
                                <form method="POST" class="p-2 m-md-4 m-0 p-0">
                                        ...
                                        <p class="small text-muted text-muted d-md-block d-none">Request to Admin for a certain amount of bills.<a href="../user/userDashboard.php" class="text-decoration-none"> Return Dashboard</a></p>
